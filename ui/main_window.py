...
class JanelaEntrada(JanelaBase):
    ...
    def _setup_left_section(self):
        ...
        # Campo e botão para buscar veículos por CPF
        ...
        # Layout para tipo de vaga e vagas disponíveis
        tipo_vaga_layout = QHBoxLayout()
        tipo_vaga_layout.addWidget(self.tipo_vaga_label)
        tipo_vaga_layout.addWidget(self.tipo_vaga_combobox)
        tipo_vaga_layout.addWidget(self.vaga_label)
        tipo_vaga_layout.addWidget(self.vaga_combobox)
        ...
        # Campo de busca e tabela de usuários cadastrados
        ...
        # Adicionar elementos ao layout esquerdo
        left_layout.addLayout(tipo_vaga_layout)  # Adicionar o layout de tipo de vaga
    ...
    def _setup_right_section(self):
        ...
        # Adicionar elementos ao layout direito
        ...
        right_layout.addWidget(self.tempo_estacionamento_combobox)
...
class JanelaConfigurarVagas(JanelaBase):
    ...
    def carregar_vagas_existentes(self):
        ...
        try:
            ...
            for vaga in vagas:
                ...
                self.tabela_vagas.setItem(row_position, 2, QTableWidgetItem(vaga[2]))  # Tipo de vaga
    ...
    def selecionar_tipo_vaga(self):
        ...
        def confirmar_selecao():
            dialog.done(1)  # Retorna 1 se "OK" for clicado

        def cancelar():
            dialog.done(0)  # Retorna 0 se "Cancelar" for clicado
        ...
        if dialog.exec_() == 1:  # Se "OK" foi clicado
            return combobox.currentText()  # Retorna o valor selecionado
        return None  # Retorna None se "Cancelar" foi clicado
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        header.setSectionResizeMode(7, QHeaderView.Stretch)  # Coluna "Tipo de vaga"
    ...
    def carregar_status_vagas(self):
        ...
        try:
            ...
            for vaga in vagas:
                ...
                self.vagas_table.setItem(row_position, 5, QTableWidgetItem(vaga[6]))  # Tipo de Vaga
    ...
    # def EscolherTipoVaga(self):
    #     self.janela = JanelaEscolherTipoVaga(self.carregar_status_vagas)
    #     self.janela.exec_()
